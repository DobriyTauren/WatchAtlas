...
public static class LocalizedText
{
    ...
    private static readonly Dictionary<string, string> RussianOverrides = new(StringComparer.Ordinal)
    {
        ...
        ["Paste markdown for one movie, or copy the message below and let your assistant prepare it for you."] = "Вставьте markdown для одного фильма или скопируйте сообщение ниже, чтобы ассистент подготовил его за вас.",
        ["Paste markdown for one show, or copy the message below and let your assistant prepare it for you."] = "Вставьте markdown для одного сериала или скопируйте сообщение ниже, чтобы ассистент подготовил его за вас.",
        ["Paste season blocks here, or copy the message below and let your assistant prepare the seasons you still need."] = "Вставьте сюда блоки сезонов или скопируйте сообщение ниже, чтобы ассистент подготовил недостающие сезоны.",
        ["Message for ChatGPT or Claude"] = "Сообщение для ChatGPT или Claude",
        ["Message for missing seasons"] = "Сообщение для недостающих сезонов",
        ["Copy this message into your assistant, then paste the markdown back here."] = "Скопируйте это сообщение в своего ассистента, а затем вставьте markdown сюда.",
        ["Movie title"] = "Название фильма",
        ["Show title"] = "Название сериала",
        ["Seasons to add"] = "Сезоны для добавления",
        ["We'll place this title into the copied message automatically."] = "Мы автоматически подставим это название в скопированное сообщение.",
        ["Use this when the show is already started and you only need the remaining seasons."] = "Используйте это, если сериал уже добавлен и вам нужны только оставшиеся сезоны.",
        ["Your markdown filled the current draft."] = "Markdown заполнил текущий черновик.",
        ["Your markdown filled the form."] = "Markdown заполнил форму.",
        ["New seasons and episodes were added to the current show."] = "Новые сезоны и эпизоды были добавлены к текущему сериалу.",
        ["A few movie details still need attention before saving."] = "Перед сохранением стоит проверить ещё несколько деталей фильма.",
        ["A few show details still need attention before saving."] = "Перед сохранением стоит проверить ещё несколько деталей сериала.",
        ["Getting your watch totals and progress ready."] = "Подготавливаем вашу статистику и прогресс просмотра.",
        ["See how your library is shaping up."] = "Посмотрите, как выглядит ваша библиотека.",
        ["Shows ordered by the time you've already watched."] = "Сериалы, отсортированные по уже просмотренному времени.",
        ["Shows ordered by watched episodes, then by time watched."] = "Сериалы, отсортированные по числу просмотренных эпизодов, а затем по времени просмотра.",
        ["Shows you're in the middle of, ordered by watched episodes and time watched."] = "Сериалы, которые вы сейчас смотрите, отсортированные по просмотренным эпизодам и времени просмотра.",
        ["Time you've watched, grouped by genre across movies and episodes."] = "Просмотренное время, сгруппированное по жанрам фильмов и эпизодов.",
        ["Time you've watched, grouped by universe across movies and shows."] = "Просмотренное время, сгруппированное по вселенным фильмов и сериалов.",
        ["Seasons ordered by the time you've watched in each one."] = "Сезоны, отсортированные по времени, которое вы просмотрели в каждом из них.",
        ["Enter the exact movie title below and copy the message."] = "Введите ниже точное название фильма и скопируйте сообщение.",
        ["Enter the exact show title below and copy the message."] = "Введите ниже точное название сериала и скопируйте сообщение.",
        ["Enter the show title and the seasons you want to add, then copy the message."] = "Введите название сериала и сезоны, которые хотите добавить, затем скопируйте сообщение.",
        ["Paste the markdown result here and click Apply Markdown."] = "Вставьте результат в формате markdown сюда и нажмите «Применить markdown».",
        ["Paste the markdown result here without extra text."] = "Вставьте сюда результат в формате markdown без лишнего текста.",
        ["Loading editor."] = "Загружаем редактор.",
        ["Preparing this movie for editing."] = "Подготавливаем этот фильм к редактированию.",
        ["Preparing this show for editing."] = "Подготавливаем этот сериал к редактированию.",
        ["This removes the movie from your library on this device."] = "Это удалит фильм из вашей библиотеки на этом устройстве.",
        ["This movie is marked as watched in your library."] = "Этот фильм отмечен в вашей библиотеке как просмотренный.",
        ["This movie is saved in your library, and you can update its progress anytime."] = "Этот фильм уже сохранён в вашей библиотеке, и вы можете в любой момент обновить его прогресс.",
        ["This removes the show, its seasons, and its episodes from your library on this device."] = "Это удалит сериал, его сезоны и эпизоды из вашей библиотеки на этом устройстве.",
        ["This show is saved and ready for seasons, episodes, and progress updates."] = "Этот сериал сохранён и готов к добавлению сезонов, эпизодов и обновлению прогресса.",
        ["Episode progress and watch time update automatically as you mark episodes watched."] = "Прогресс по эпизодам и время просмотра обновляются автоматически, когда вы отмечаете эпизоды просмотренными.",
        ["A backup of your library and settings has been downloaded."] = "Резервная копия вашей библиотеки и настроек была скачана.",
        ["A simple place to keep track of what you watch."] = "Простое место, чтобы следить за тем, что вы смотрите.",
        ["Add a cover image from the edit page to make this movie feel complete."] = "Добавьте обложку на странице редактирования, чтобы карточка фильма выглядела завершённой.",
        ["Add a cover image from the edit page to make this show feel complete."] = "Добавьте обложку на странице редактирования, чтобы карточка сериала выглядела завершённой.",
        ["Add movies and shows, follow episode progress, and see your watch time in one place."] = "Добавляйте фильмы и сериалы, следите за прогрессом по эпизодам и смотрите время просмотра в одном месте.",
        ["Adjust how the app looks and how the library opens."] = "Настройте внешний вид приложения и то, как открывается библиотека.",
        ["Adjust the app to your liking, keep a backup, or clear everything on this device."] = "Настройте приложение под себя, сохраните резервную копию или очистите данные на этом устройстве.",
        ["All movies, shows, seasons, episodes, covers, filters, and preferences will be removed from this device."] = "Все фильмы, сериалы, сезоны, эпизоды, обложки, фильтры и настройки будут удалены с этого устройства.",
        ["Apply Markdown"] = "Применить markdown",
        ["Browse your watch library."] = "Просматривайте свою библиотеку просмотра.",
        ["Choose a WatchAtlas backup file in JSON format."] = "Выберите файл резервной копии WatchAtlas в формате JSON.",
        ["Choose your language, backup your library, and manage your data."] = "Выберите язык, сохраните библиотеку и управляйте своими данными.",
        ["Clear all app data on this device?"] = "Очистить все данные приложения на этом устройстве?",
        ["Clear library and preferences"] = "Очистить библиотеку и настройки",
        ["Copy Message"] = "Скопировать сообщение",
        ["Copy this message into ChatGPT or another assistant, then paste the result back here."] = "Скопируйте это сообщение в ChatGPT или другой ассистент, а затем вставьте результат сюда.",
        ["Create a movie first, then come back here to review its details and watch status."] = "Сначала создайте фильм, а потом вернитесь сюда, чтобы посмотреть его детали и статус просмотра.",
        ["Create an item first, then come back here to edit details and track progress."] = "Сначала создайте элемент, а потом вернитесь сюда, чтобы редактировать детали и отслеживать прогресс.",
        ["Create it first, then come back here to edit it."] = "Сначала создайте его, а потом вернитесь сюда для редактирования.",
        ["Download a backup of your library and settings."] = "Скачайте резервную копию своей библиотеки и настроек.",
        ["Edit this item and update its details and progress."] = "Редактируйте этот элемент и обновляйте его детали и прогресс.",
        ["Getting your library ready."] = "Подготавливаем вашу библиотеку.",
        ["Go back home or open your library to keep browsing."] = "Вернитесь на главную или откройте библиотеку, чтобы продолжить.",
        ["Imported with a few warnings."] = "Импорт завершён с несколькими предупреждениями.",
        ["Importing a backup will replace your current library and settings after confirmation."] = "Импорт резервной копии заменит вашу текущую библиотеку и настройки после подтверждения.",
        ["Keep track of what you watch, see your progress, and pick up where you left off."] = "Следите за тем, что вы смотрите, смотрите свой прогресс и возвращайтесь к просмотру с того места, где остановились.",
        ["Keep your movies, shows, seasons, and episodes in one clear library."] = "Храните фильмы, сериалы, сезоны и эпизоды в одной понятной библиотеке.",
        ["Loading movie."] = "Загружаем фильм.",
        ["Loading show."] = "Загружаем сериал.",
        ["Loading your movies, shows, and progress."] = "Загружаем ваши фильмы, сериалы и прогресс.",
        ["Markdown"] = "Markdown",
        ["Message copied."] = "Сообщение скопировано.",
        ["Message for your assistant"] = "Сообщение для вашего ассистента",
        ["No description yet. Open details to add cover art and richer tracking info."] = "Описания пока нет. Откройте детали, чтобы добавить обложку и больше информации.",
        ["No shows found."] = "Сериалы не найдены.",
        ["Nothing to show here yet."] = "Здесь пока нечего показывать.",
        ["Opening the selected movie from your library."] = "Открываем выбранный фильм из вашей библиотеки.",
        ["Opening the selected show from your library."] = "Открываем выбранный сериал из вашей библиотеки.",
        ["Paste it into your assistant to get the markdown."] = "Вставьте это в ассистента, чтобы получить markdown.",
        ["Paste the markdown here when it's ready."] = "Вставьте сюда markdown, когда он будет готов.",
        ["Prepare the markdown first, then paste it here."] = "Сначала подготовьте markdown, а потом вставьте его сюда.",
        ["Replace your current library with this backup?"] = "Заменить текущую библиотеку этой резервной копией?",
        ["Reset app data on this device"] = "Сбросить данные приложения на этом устройстве",
        ["Restoring a backup replaces your current library and settings."] = "Восстановление резервной копии заменит вашу текущую библиотеку и настройки.",
        ["Save a backup before clearing data or moving to another device."] = "Сохраните резервную копию перед очисткой данных или переносом на другое устройство.",
        ["Save a backup of your library"] = "Сохранить резервную копию библиотеки",
        ["Search, filter, sort, and switch layouts across your movies and shows."] = "Ищите, фильтруйте, сортируйте и переключайте режимы просмотра для фильмов и сериалов.",
        ["See how much time you've spent on movies and episodes, and how much is still left."] = "Посмотрите, сколько времени вы уже потратили на фильмы и эпизоды и сколько ещё осталось.",
        ["Switch between light, dark, and pastel themes. Your choice is saved automatically."] = "Переключайтесь между светлой, тёмной и пастельной темами. Ваш выбор сохраняется автоматически.",
        ["The full message will be copied to your clipboard."] = "Полное сообщение будет скопировано в буфер обмена.",
        ["The link may be outdated, or the page may not exist yet."] = "Ссылка может быть устаревшей, или страница ещё не существует.",
        ["The selected backup replaced your current library and settings."] = "Выбранная резервная копия заменила вашу текущую библиотеку и настройки.",
        ["This page could not be found."] = "Эта страница не найдена.",
        ["This permanently removes your library and saved preferences from this device."] = "Это навсегда удалит библиотеку и сохранённые настройки с этого устройства.",
        ["This removes your library and saved preferences from this device."] = "Это удалит библиотеку и сохранённые настройки с этого устройства.",
        ["This will replace your current library and settings. Export a backup first if you want an extra copy."] = "Это заменит вашу текущую библиотеку и настройки. Сначала экспортируйте резервную копию, если хотите сохранить дополнительную копию.",
        ["Time left in what you've added so far."] = "Время, которое осталось в уже добавленных материалах.",
        ["Time watched across your episodes."] = "Время, просмотренное по эпизодам.",
        ["Time watched across your library."] = "Время, просмотренное по всей библиотеке.",
        ["Time watched across your movies."] = "Время, просмотренное по фильмам.",
        ["Track movies and shows in one place."] = "Следите за фильмами и сериалами в одном месте.",
        ["Update the details and watch status for this movie."] = "Обновите детали и статус просмотра этого фильма.",
        ["Use this if you want to remove everything from this device and start over."] = "Используйте это, если хотите удалить всё с этого устройства и начать заново.",
        ["WatchAtlas uses your browser language the first time you open it. You can change it here anytime."] = "При первом открытии WatchAtlas использует язык вашего браузера. Здесь его можно изменить в любой момент.",
        ["We couldn't find this item in your library."] = "Мы не смогли найти этот элемент в вашей библиотеке.",
        ["We couldn't find this movie in your library."] = "Мы не смогли найти этот фильм в вашей библиотеке.",
        ["We couldn't find this show in your library."] = "Мы не смогли найти этот сериал в вашей библиотеке.",
        ["Your current library, filters, theme, and settings will be replaced after confirmation."] = "После подтверждения будут заменены ваша текущая библиотека, фильтры, тема и настройки.",
        ["Your library and saved preferences were removed from this device."] = "Ваша библиотека и сохранённые настройки были удалены с этого устройства.",
        ["Your watch library"] = "Ваша библиотека просмотра",
        ["See how much time you've already watched and how much is left."] = "Сколько времени уже просмотрено и сколько ещё осталось.",
        ["Time spent on movies."] = "Время просмотра фильмов.",
        ["Time spent on episodes."] = "Время просмотра эпизодов.",
        ["Total time watched in your library."] = "Общее время просмотра в библиотеке.",
        ["How much time is left to watch."] = "Сколько времени ещё осталось посмотреть."
    };
    ...
    public static string FormatDuration(int minutes)
    {
        if (GetCurrentLanguage() == AppLanguage.Russian)
        {
            ...
            {
                0 => $"{russianRemainingMinutes}м",
                _ when russianRemainingMinutes == 0 => $"{russianHours}ч",
                _ => $"{russianHours}ч {russianRemainingMinutes}м"
            };
        }
