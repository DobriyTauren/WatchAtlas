...
public static class LocalizedText
{
    ...
    static LocalizedText()
    {
        AddTranslations(new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Add Movie or Show"] = "Добавить фильм или сериал",
            ["Soft tracking for movies and shows."] = "Мягкий трекинг фильмов и сериалов.",
            ["Keep movies, shows, seasons, and episodes in one calm, easy-to-browse library."] = "Храните фильмы, сериалы, сезоны и эпизоды в одной спокойной и удобной библиотеке.",
            ...
            ["Exports the full library snapshot, including movies, shows, seasons, episodes, and current app settings."] = "Экспортирует полный снимок библиотеки, включая фильмы, сериалы, сезоны, эпизоды и текущие настройки приложения.",
            ...
            ["All movies, shows, seasons, episodes, cover images, filters, and preferences will be removed from this device."] = "Все фильмы, сериалы, сезоны, эпизоды, обложки, фильтры и настройки будут удалены с этого устройства.",
            ...
            ["Selected Show"] = "Выбранный сериал",
            ...
            ["Start by adding your first movie or show. Once it is saved, this page becomes your main browsing hub for search, filters, and progress tracking."] = "Начните с добавления первого фильма или сериала. После сохранения эта страница станет вашим основным местом для поиска, фильтров и отслеживания прогресса.",
            ...
            ["A quick breakdown of watched versus remaining items across movies, shows, and episodes."] = "Быстрая разбивка просмотренного и оставшегося по фильмам, сериалам и эпизодам.",
            ["Movie Watch Rate"] = "Доля просмотренных фильмов",
            ["Episode Watch Rate"] = "Доля просмотренных эпизодов",
            ["Completed Shows"] = "Завершённые сериалы",
            ...
            ["Shows Added"] = "Добавленные сериалы",
            ...
            ["Rankings"] = "Рейтинги",
            ["Top shows by watched duration."] = "Топ сериалов по времени просмотра.",
            ["Shows ordered by the amount of watched runtime already logged in the library."] = "Сериалы, отсортированные по уже зафиксированному времени просмотра.",
            ["No tracked shows runtime yet. Add a show with seasons and watched episodes to see rankings here."] = "Пока нет отслеживаемого времени сериалов. Добавьте сериал с сезонами и просмотренными эпизодами, чтобы увидеть рейтинг.",
            ["Most episodes watched."] = "Больше всего просмотренных эпизодов.",
            ["Shows ranked by watched episode count, then by logged watch time."] = "Сериалы, отсортированные по числу просмотренных эпизодов, затем по времени просмотра.",
            ...
            ["Shows that are in progress right now, ranked by watched episodes and active watch time."] = "Сериалы в процессе просмотра, отсортированные по просмотренным эпизодам и активному времени.",
            ["No in-progress shows yet. Once a show is partly watched, it will show up here."] = "Пока нет сериалов в процессе. Когда сериал будет частично просмотрен, он появится здесь.",
            ["Genres"] = "Жанры",
            ...
            ["Getting your movies, shows, and watch progress ready."] = "Подготавливаем фильмы, сериалы и прогресс просмотра.",
            ...
            ["Add films and shows, follow episode progress, and keep an eye on your total watch time without losing the calm feel of a personal collection."] = "Добавляйте фильмы и сериалы, следите за прогрессом по эпизодам и общим временем просмотра без ощущения перегруженности.",
            ["Movies you've already marked as watched."] = "Фильмы, которые вы уже отметили как просмотренные.",
            ["Shows currently in your library."] = "Сериалы, которые сейчас есть в вашей библиотеке.",
            ...
            ["Add a cover image from the edit page to give the show page a stronger visual identity."] = "Добавьте обложку на странице редактирования, чтобы страница сериала выглядела выразительнее.",
            ...
            ["Add a show to your library."] = "Добавьте сериал в свою библиотеку.",
            ...
            ["Choose an external cover URL or upload a local show key art image."] = "Укажите внешний URL обложки или загрузите локальное изображение сериала.",
            ...
            ["Create a show first or return to the library to pick an existing entry."] = "Сначала создайте сериал или вернитесь в библиотеку, чтобы выбрать существующую запись.",
            ["Create a show first, then return here to review seasons, episodes, and progress."] = "Сначала создайте сериал, затем вернитесь сюда, чтобы просмотреть сезоны, эпизоды и прогресс.",
            ["Create Movie"] = "Создать фильм",
            ["Create Show"] = "Создать сериал",
            ["Delete Movie"] = "Удалить фильм",
            ["Delete Show"] = "Удалить сериал",
            ["Delete this movie?"] = "Удалить этот фильм?",
            ["Delete this show?"] = "Удалить этот сериал?",
            ["Description"] = "Описание",
            ["Duration"] = "Длительность",
            ["Duration (minutes)"] = "Длительность (минуты)",
            ["Edit Movie"] = "Редактировать фильм",
            ["Edit Show"] = "Редактировать сериал",
            ...
            ["Fill Show From Markdown"] = "Заполнить сериал из Markdown",
            ["Fill this movie from markdown"] = "Заполнить фильм из markdown",
            ["Fill this show from markdown"] = "Заполнить сериал из markdown",
            ...
            ["Getting this show ready to edit."] = "Подготавливаем сериал к редактированию.",
            ...
            ["Loading show details."] = "Загружаем детали сериала.",
            ["Loading show editor."] = "Загружаем редактор сериала.",
            ["Mark Entire Show Watched"] = "Отметить весь сериал как просмотренный",
            ...
            ["New seasons and episodes were appended to the current show draft."] = "Новые сезоны и эпизоды добавлены в текущий черновик сериала.",
            ...
            ["No seasons yet. Add one to start structuring the show."] = "Сезонов пока нет. Добавьте один, чтобы начать структурировать сериал.",
            ["No show found."] = "Сериал не найден.",
            ...
            ["Paste one clean markdown document for a single show, or copy the AI prompt below to generate it automatically in the right format."] = "Вставьте один аккуратный markdown-документ для сериала или скопируйте AI-промпт ниже, чтобы сгенерировать его автоматически в правильном формате.",
            ...
            ["Please review the show form."] = "Проверьте форму сериала.",
            ...
            ["Reading the selected show from browser storage."] = "Читаем выбранный сериал из хранилища браузера.",
            ["Remove"] = "Удалить",
            ...
            ["See a full show example"] = "Посмотреть полный пример сериала",
            ...
            ["Show created."] = "Сериал создан.",
            ["Show deleted."] = "Сериал удалён.",
            ["Show Details"] = "Детали сериала",
            ["Show details added."] = "Детали сериала добавлены.",
            ["Show Editor"] = "Редактор сериала",
            ["Show not found."] = "Сериал не найден.",
            ["Show saved."] = "Сериал сохранён.",
            ["Show title for AI"] = "Название сериала для ИИ",
            ["Set up the show, then add seasons and episodes whenever you're ready."] = "Настройте сериал, а затем добавляйте сезоны и эпизоды, когда будете готовы.",
            ...
            ["Some show details still need attention before save."] = "Некоторые детали сериала требуют внимания перед сохранением.",
            ...
            ["The details route is ready, but the requested show was not found in browser storage."] = "Маршрут деталей готов, но запрошенный сериал не найден в хранилище браузера.",
            ...
            ["The new show has been saved in your library."] = "Новый сериал сохранён в вашей библиотеке.",
            ["The show form was filled from your markdown."] = "Форма сериала была заполнена из вашего markdown.",
            ...
            ["This permanently removes the show and all stored seasons and episodes from browser storage."] = "Это навсегда удалит сериал и все сохранённые сезоны и эпизоды из хранилища браузера.",
            ["This season does not contain any episodes yet."] = "Этот сезон пока не содержит эпизодов.",
            ["This show could not be found."] = "Этот сериал не удалось найти.",
            ["This show is not in the library yet."] = "Этого сериала пока нет в библиотеке.",
            ["This show is saved and ready for seasons, episodes, and watch tracking."] = "Этот сериал сохранён и готов для добавления сезонов, эпизодов и отслеживания просмотра.",
            ...
            ["Tracked in this show."] = "Отслеживается в этом сериале.",
            ["Update the details, notes, and watch status for this movie."] = "Обновите детали, заметки и статус просмотра этого фильма.",
            ["Update the show details, seasons, and episodes."] = "Обновите детали сериала, сезоны и эпизоды.",
            ["Upload"] = "Загрузить",
            ...
            ["Use this when you already have a show draft and want your assistant to generate only the missing seasons."] = "Используйте это, если у вас уже есть черновик сериала и вы хотите, чтобы ассистент сгенерировал только недостающие сезоны.",
            ...
            ["Your show details were updated successfully."] = "Детали сериала успешно обновлены.",
            ["Add Media"] = "Добавить медиа",
            ["New Media"] = "Новое медиа",
            ["Add a movie or show to your library."] = "Добавьте фильм или сериал в свою библиотеку.",
        ...
        AddTranslations(new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Enter the exact show title below and copy the AI prompt."] = "Введите ниже точное название сериала и скопируйте AI-промпт.",
            ["Enter the show title and the seasons you want to add, then copy the AI prompt."] = "Введите название сериала и сезоны, которые хотите добавить, затем скопируйте AI-промпт.",
            ...
            ["Paste the result here to append the new seasons to the current show draft."] = "Вставьте результат сюда, чтобы добавить новые сезоны в текущий черновик сериала.",
    ...
    public static string FormatCount(int count, string nounKey, string? plural = null)
    {
        if (GetCurrentLanguage() == AppLanguage.Russian)
        {
            var russianForms = nounKey switch
            {
                ...
                "title" => ("произведение", "произведения", "произведений"),
